import type { Awaitable, ResultAsync, ResultPayload } from "./types.ts";
...
export class Result<T, E = string> {
  ...
  public static async fromAsync<T, E = string>( fn: ( ...args: any[] ) => Awaitable<T>, ...args: Parameters<typeof fn> ): ResultAsync<Awaited<T>, E> {
    try {
      ...
      return Result.Err<E>((e instanceof Error ? e.message : String(e)) as E);
    }
  }
  
  public static from<T, E = string>( fn: ( ...args: any[] ) => T, ...args: Parameters<typeof fn> ): Result<T, E> {
    try {
